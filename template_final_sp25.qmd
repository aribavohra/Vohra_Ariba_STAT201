...
print(paste("You generated", count, "numbers that sum to", sum, "."))
...
print(paste("Your BMI is", category_value, "with a value of", bmi_value, "."))
```
...
```{r}
sum_function <- sapply(list_2, function(x) sum(x) %% 2 == 0)
print(sum_function)
```
