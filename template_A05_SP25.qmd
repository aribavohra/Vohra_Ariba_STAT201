...
minute_label <- ifelse(minutes==1,"minute","minutes")
seconds_label <- ifelse(seconds==1,"second","seconds")
cat(var_seconds, "seconds is", minutes, minute_label, "and", seconds, seconds_label)
```
...
if (s > 1) {
  ...
  if (is_prime) {
    cat(s, "is a prime number.\n")
  } else {
    cat(s, "is not a prime number.\n")
  }
} else {
  cat(s, "is not a prime number.\n")
}
